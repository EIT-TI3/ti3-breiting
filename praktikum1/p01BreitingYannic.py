...
def encode(message, code):
    ...
    return ''.join([char for encoded_number in encoded_message for char, number in mapping.items() if number == encoded_number])
...
result1 = ''.join([char for encoded_number in result_val1 for char, number in mapping.items() if number == encoded_number])
...
result = ''.join([char for encoded_number in result_val for char, number in mapping.items() if number == encoded_number])
